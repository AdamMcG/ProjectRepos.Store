...
public class LeaveSelectionScreen {
	...
	private void initialize() {
		...
		rdbtnHolidayLeave.setBounds(392, 99, 147, 43);
		...
		rdbtnGeneralLeave.setBounds(207, 193, 147, 43);
		...
		btnNewButton_1.setBounds(439, 311, 100, 43);
		panel.add(btnNewButton_1);
		frame.setBounds(100, 100, 684, 453);
