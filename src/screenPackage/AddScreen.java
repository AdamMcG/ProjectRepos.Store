...
public class AddScreen extends JFrame implements ActionListener {
	...
	private JTextField textFName, txtEmployNum, textEmpTitle, textDepartment,
			textContractDateStart, textContractLength, textFieldAddress;
	...
	public AddScreen(ResultSet data, CreateDBOperations ad) {
		...
		textFName.setBounds(106, 78, 101, 20);
		panel.add(textFName);
		textFName.setColumns(10);

		JLabel lblEmployeeNo = new JLabel("Fast Name:");
		...
		lblPassword.setBounds(10, 198, 59, 30);
		...
		genderMale.setBounds(106, 231, 54, 23);
		panel.add(genderMale);
		genderMale.addActionListener(this);
		genderFemale = new JRadioButton("Female");
		genderFemale.setBounds(180, 231, 70, 23);
		...
		lblGender.setBounds(10, 230, 72, 23);
		panel.add(lblGender);
		...
		panel_1.setBounds(10, 329, 301, 207);
		panel.add(panel_1);
		...
		lblContractDescription.setBounds(10, 86, 135, 24);
		...
		PasswordField.setBounds(141, 547, 101, 20);
		panel.add(PasswordField);
		PasswordField.setColumns(10);

		JLabel lblPassword_1 = new JLabel("Password");
		lblPassword_1.setBounds(10, 549, 69, 17);
		panel.add(lblPassword_1);

		JLabel lblAddress = new JLabel("Address");
		lblAddress.setBounds(10, 148, 46, 30);
		panel.add(lblAddress);

		textFieldAddress = new JTextField();
		textFieldAddress.setBounds(106, 153, 101, 20);
		panel.add(textFieldAddress);
		textFieldAddress.setColumns(10);

		JLabel lastName = new JLabel("Last Name:");
		lastName.setFont(new Font("Arial", Font.PLAIN, 13));
		lastName.setBounds(10, 109, 72, 28);
		panel.add(lastName);

		textLName = new JTextField();
		textLName.setBounds(106, 114, 101, 20);
		panel.add(textLName);
	...
	public void addNewUser() {
		try {
			...
			user = new User(fname, lname, address, gender, "Ireland",
					empNumber(), contract, title, pass, dept);
